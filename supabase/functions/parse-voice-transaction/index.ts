...
- "قبضت 1000 شيكل من الزبون سلام صايمة" → {"debit": "الصندوق", "credit": "العملاء", "amount": "₪1000", "description": "قبض من الزبون سلام صايمة", "contactName": "سلام صايمة"}

ملاحظة مهمة: كلمة "الزبون" و"العميل" لهما نفس المعنى تماماً. استخرج اسم جهة الاتصال في كلتا الحالتين.

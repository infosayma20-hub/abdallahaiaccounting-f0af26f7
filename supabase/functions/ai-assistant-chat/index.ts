...
7. عند اقتراح إجراء يجب على المستخدم اتخاذه، استخدم دائماً الصيغة: [action:وصف الإجراء:/المسار]
   أمثلة: [action:تسجيل إيداع رأس المال:/] أو [action:عرض كشف الحسابات:/accounts]
   هذه العلامات تتحول لأزرار تفاعلية — لا تكتبها كنص عادي أبداً

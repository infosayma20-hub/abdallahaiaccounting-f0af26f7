...
-- Remove anon access to companies and company_settings (now served via edge function)
DROP POLICY IF EXISTS "Public can view company name for receipt" ON public.companies;
DROP POLICY IF EXISTS "Public can view company settings for receipt display" ON public.company_settings;

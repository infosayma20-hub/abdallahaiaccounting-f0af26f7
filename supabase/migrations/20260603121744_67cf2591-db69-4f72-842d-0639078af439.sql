DROP FUNCTION IF EXISTS public.feedback_followup_queue(date, date, int, text, uuid, text, boolean, text, int, int, int);
...
GRANT EXECUTE ON FUNCTION public.feedback_followup_queue(date, date, int, text, uuid, text, boolean, text, int, int, int) TO authenticated;
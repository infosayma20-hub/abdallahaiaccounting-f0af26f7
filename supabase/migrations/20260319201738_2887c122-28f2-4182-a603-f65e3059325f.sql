...
BEGIN
  ...
  -- Map currency code to Arabic label for the currency field
  ...
  IF v_is_foreign THEN
    -- Foreign currency sale: store with the ACTUAL foreign currency label
    -- so balance queries can detect the foreign amount

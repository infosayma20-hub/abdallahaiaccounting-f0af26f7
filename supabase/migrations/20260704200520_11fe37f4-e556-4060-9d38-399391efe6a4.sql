...
BEGIN
  ...
  -- 1) Unlink & restore all payment_invoice_links tied to any transaction of this bulk voucher.
  FOR v_tx IN
  ...
  LOOP
    ...
    DELETE FROM public.payment_invoice_links WHERE payment_id = v_tx.id;
  END LOOP;

  -- 2) Soft-delete all transactions belonging to this bulk voucher.

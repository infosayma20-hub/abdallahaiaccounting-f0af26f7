...
BEGIN
  ...
  IF v_debit_account.id IS NOT NULL
     AND v_debit_account.parent_code IN ('1130','2110')
  ...
  IF v_credit_account.id IS NOT NULL
     AND v_credit_account.parent_code IN ('1130','2110')

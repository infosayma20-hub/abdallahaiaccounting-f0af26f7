INSERT INTO public.form_templates (
  is_system, name, description, category, frequency,
  target_job_title_names, reviewer_role, is_active, schema
) VALUES (
  true,
  'إدارة العمليات والتتبع اليومي',
  'FM-OPT-001 — نموذج يومي لتوثيق عمليات الاستلام والإنتاج وضبط المخازن والفحوص المخبرية وفق ISO 22000:2018.',
  'operations',
  'daily',
  ARRAY['مشرف الوردية','مدير الجودة','قائد فريق السلامة الغذائية']::text[],
  'admin',
  true,
  '{
    "sections": [

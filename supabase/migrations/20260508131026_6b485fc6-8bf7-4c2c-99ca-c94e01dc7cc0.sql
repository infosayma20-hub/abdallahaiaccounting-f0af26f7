-- =====================================================================
-- POS Tax Ledger Integration (canonical names per QA plan)
-- Function: public.fn_pos_order_tax_ledger
-- Trigger : trg_pos_order_tax_ledger ON public.pos_orders
-- =====================================================================
...
-- Canonical trigger function (per QA plan)
...
-- Drop legacy / variant triggers, then create canonical
DROP TRIGGER IF EXISTS pos_orders_tax_ledger_sync ON public.pos_orders;
DROP TRIGGER IF EXISTS trg_pos_order_tax_ledger ON public.pos_orders;

CREATE TRIGGER trg_pos_order_tax_ledger
AFTER INSERT OR UPDATE OR DELETE ON public.pos_orders
FOR EACH ROW EXECUTE FUNCTION public.fn_pos_order_tax_ledger();

-- Drop legacy trigger function name if it ever existed
DROP FUNCTION IF EXISTS public.trg_pos_orders_tax_ledger_sync();
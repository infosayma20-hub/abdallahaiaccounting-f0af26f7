...
BEGIN
  ...
  WITH agg AS (
    SELECT
      ...
      max(o.target_branch_id) AS branch_id_v,
      max(o.target_branch_name) AS branch_name_v,
...
GRANT EXECUTE ON FUNCTION public.feedback_followup_queue(date,date,int) TO authenticated;
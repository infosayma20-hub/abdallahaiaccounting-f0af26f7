...
BEGIN
  ...
  IF NOT v_allowed AND (
    ...
    OR public.has_role(v_caller, 'cashier'::app_role)
  ...
  IF NOT v_allowed THEN
    RAISE EXCEPTION 'غير مصرح: لا يمكن تعديل أو حذف حركات وجبات POS إلا من قبل الكاشير أو المشرف أو المحاسب أو مدير الموارد البشرية'
      USING ERRCODE = '42501';
  END IF;

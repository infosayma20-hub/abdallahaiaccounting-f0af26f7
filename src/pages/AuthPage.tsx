...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col" dir="ltr">
      ...
      >
        <img src="/logo-white.png" alt="QOYOD" className="h-8 object-contain" />
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
            <div className="text-center space-y-8 max-w-sm">
              <div className="flex flex-col items-center gap-4">
                <img src="/logo-white.png" alt="QOYOD قيود" width={200} />
              </div>
        ...
        <div className="flex-1 flex items-center justify-center px-4 py-8" style={{ background: '#F8F9FA' }} dir="rtl">
          <div className="w-full max-w-sm space-y-5">
            ...
            <div className="flex flex-col items-center gap-3 mb-2">
              <img src="/q-logo-navy.png" alt="QOYOD" className="w-20 h-20 object-contain" />
              ...
              {mode === "login" && (
                ...
                >
                  <div className="text-right">
                    ...
                    <p className="text-[11px]" style={{ color: '#6B7280' }}>لم تسجل بعد؟ جرب QOYOD مجاناً</p>
                  </div>
                  <button
                    onClick={() => setMode("signup")}

          ...
          <div className="w-full max-w-[440px] my-auto py-2">
            ...
            {mode !== "forgot" && (
              <button
                ...
                className="w-full flex items-center justify-center h-11 rounded-xl transition-all mb-5 group"
                style={{ background: 'transparent' }}
              >
                <svg className="h-8 w-8 transition-transform duration-200 group-hover:scale-110" viewBox="0 0 24 24">

...
const SAMPLE_ORDER: PrintOrder = {
  ...
  branchName: "",
  tableNumber: "",
  orderNote: "الزبون بيستلم الساعة 10، يرجى تجهيز الطلبية بشكل خاص بدون بصل وبدون ثوم وبصلصة حارة على الجنب، والاتصال على الزبون قبل التحضير بربع ساعة للتأكيد، وإرفاق مناديل إضافية وكاتشب وملاعق بلاستيك مع الطلبية كاملة، شكراً.",
};

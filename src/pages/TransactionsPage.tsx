...
const typeBadgeConfig: Record<string, { label: string; bg: string; text: string }> = {
  ...
  manual_journal:     { label: "قيد يدوي",       bg: "bg-[#F3F4F6]", text: "text-[#374151]" },
  currency_exchange:  { label: "صرف عملة",       bg: "bg-[#FEF9C3]", text: "text-[#854D0E]" },
  pos_meal_subsidy:   { label: "دعم وجبة موظف",  bg: "bg-[#FFEDD5]", text: "text-[#9A3412]" },
  pos_payment_adjustment: { label: "تعديل دفع POS", bg: "bg-[#FEF3C7]", text: "text-[#92400E]" },

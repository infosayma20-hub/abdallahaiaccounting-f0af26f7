...
export const KIOSK_T = {
  ar: {
    ...
    empty_cart_sub: "اختر وجبتك المفضلة للبدء",
    added_title: "تمت الإضافة",
    added_sub: "تمت إضافة المنتج إلى طلبك",
    review_order: "مراجعة الطلب",
    confirm_and_pay: "تأكيد الطلب والدفع",
    back_to_menu: "العودة للقائمة",
    order_received: "تم استلام طلبك بنجاح",
    preparing_soon: "سيتم تحضير طلبك قريباً",
  ...
  en: {
    ...
    empty_cart_sub: "Pick a meal to get started",
    added_title: "Added",
    added_sub: "Item added to your order",
    review_order: "Review Order",
    confirm_and_pay: "Confirm & Pay",
    back_to_menu: "Back to menu",
    order_received: "Your order was received",
    preparing_soon: "Your order will be ready soon",

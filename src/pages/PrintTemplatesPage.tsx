  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        {showAmwaliActivation && (
          <div
            onClick={() => navigate("/contracts/amwali-quote")}
            className="group bg-gradient-to-br from-[#1B3A5C] to-[#0D1B2E] text-white border border-[#0D1B2E] rounded-xl p-4 flex flex-col items-center text-center cursor-pointer transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5"
          >
            <div className="w-20 h-20 rounded-2xl bg-white/10 flex items-center justify-center mb-3">

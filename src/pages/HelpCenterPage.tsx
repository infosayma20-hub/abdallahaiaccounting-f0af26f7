...
const faqItems = [
  ...
  { q: "هل يدعم النظام أكثر من عملة؟", a: "نعم، يدعم يونيفاي الشيكل الإسرائيلي (ILS)، الدولار الأمريكي (USD)، والدينار الأردني (JOD) مع تحويل تلقائي وقيود مزدوجة لكل عملة." },
  ...
  { q: "هل بياناتي آمنة؟", a: "نعم، يعمل يونيفاي على بنية سحابية مع تشفير كامل وسياسات أمان على مستوى الصف (RLS) لحماية بيانات كل مؤسسة بشكل مستقل تماماً." },
      ...
      >
        <div className="mx-auto max-w-2xl text-center space-y-3">
          ...
          <p className="text-white/70 text-sm sm:text-base">
            مقالات تفصيلية تساعدك في استخدام يونيفاي بشكل فعّال
          </p>

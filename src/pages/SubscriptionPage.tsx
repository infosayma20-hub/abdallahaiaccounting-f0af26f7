    ...
    <div className="min-h-full pb-20" dir="rtl" style={{ fontFamily: "Tajawal, sans-serif" }}>
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-10">
        ...
        <div className="space-y-5">
          <h2 className="text-2xl font-medium text-center text-foreground">إضافات يونيفاي</h2>
        ...
        <div className="space-y-5 pt-6">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">كل ما تريد معرفته حول مزايا الاشتراك في يونيفاي</p>
          </div>

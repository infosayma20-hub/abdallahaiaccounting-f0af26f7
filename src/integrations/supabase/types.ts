  ...
  public: {
    Tables: {
      ...
      employee_allowed_branches: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_allowed_branches_branch_id_fkey"
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "branches"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_allowed_branches_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
      ...
      vouchers: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "vouchers_cash_box_id_fkey"
            columns: ["cash_box_id"]
            isOneToOne: false
            referencedRelation: "cash_boxes"
            referencedColumns: ["id"]

...
> ⚠️ **المفتاح للخادم فقط (Server-side only).** لا تضعه داخل تطبيق الجوال أو كود المتصفح ولا في مستودع عام — أي مفتاح يُشحن مع التطبيق يُعتبر مسرّباً. أرسل كل الطلبات من خادم التطبيق (Backend) واحتفظ بالمفتاح في متغيّرات بيئة. عند الشك أوقف المفتاح فوراً من: الإعدادات ← التكاملات ← مفاتيح API، وأصدر مفتاحاً جديداً.

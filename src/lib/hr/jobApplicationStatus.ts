...
export const JOB_APPLICATION_STATUSES: readonly JobApplicationStatusDefinition[] = [
  ...
  { key: "interview_completed_pending_evaluation", label: "تمت المقابلة – بانتظار التقييم", group: "interview", badgeClass: "border-warning/30 bg-warning/10 text-warning-foreground" },
  { key: "reserve_candidate", label: "مرشح احتياطي", group: "decision", badgeClass: "border-warning/30 bg-warning/10 text-warning-foreground" },
  ...
  { key: "follow_up_later", label: "مؤجل للمتابعة لاحقًا", group: "closed", badgeClass: "border-warning/30 bg-warning/10 text-warning-foreground" },

...
const moduleColors: Record<string, { accent: string; bg: string; gradient?: string }> = {
  ...
  ecommerce:   { accent: "#4A9EE8", bg: "rgba(74,158,232,0.12)", gradient: "linear-gradient(135deg, #4A9EE8, #7BB8F0)" },
  ...
  assets:      { accent: "#4A9EE8", bg: "rgba(74,158,232,0.12)", gradient: "linear-gradient(135deg, #4A9EE8, #7BB8F0)" },

...
const moduleColors: Record<string, { accent: string; bg: string; gradient?: string }> = {
  ...
  ecommerce:   { accent: "#4A9EE8", bg: "rgba(201,168,76,0.12)", gradient: "linear-gradient(135deg, #4A9EE8, #E8C860)" },
  ...
  assets:      { accent: "#4A9EE8", bg: "rgba(201,168,76,0.12)", gradient: "linear-gradient(135deg, #4A9EE8, #E8C860)" },

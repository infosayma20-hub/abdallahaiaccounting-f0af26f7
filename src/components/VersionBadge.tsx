...
export default function VersionBadge() {
  ...
  // ارفع الشارة فوق شريط التنقل السفلي في البورتالات الموبايل (مندوب/موظف/مالك/سائق...)
  ...
  return (
    <button
      ...
      className={`fixed ${
        isPos ? "top-1 left-1" : liftAboveBottomNav ? "bottom-[68px] left-1" : "bottom-1 left-1"
      } z-[60] px-1.5 py-0.5 rounded text-[9px] leading-none font-mono tabular-nums text-muted-foreground/60 hover:text-foreground hover:bg-muted/60 bg-background/40 backdrop-blur-sm border border-border/40 select-none print:hidden pointer-events-auto`}
      dir="ltr"
    >

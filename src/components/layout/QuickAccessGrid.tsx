...
const ALL_ITEMS: QuickAccessItem[] = [
  ...
  { id: "payment", label: "سند صرف", icon: Wallet, shortcut: "F3", path: "/finance/payments?new=1", enabled: true },
  { id: "journal", label: "سند قيد", icon: ClipboardList, shortcut: "F4", path: "/finance/journals?new=1", enabled: true },
  { id: "customers", label: "زبائن", icon: Users, shortcut: "Ctrl+Z", path: "/contacts?type=customer", enabled: true },
  { id: "suppliers", label: "موردين", icon: Store, shortcut: "Ctrl+M", path: "/contacts?type=supplier", enabled: true },
  { id: "account_stmt", label: "كشف حساب", icon: BarChart3, shortcut: "Ctrl+K", path: "/finance/account-statement", enabled: true },
  { id: "cash_boxes", label: "صناديق", icon: Banknote, shortcut: "Ctrl+S", path: "/finance/cash-boxes", enabled: true },
  ...
  { id: "trial_balance", label: "ميزان المراجعة", icon: Calculator, path: "/trial-balance", enabled: false },

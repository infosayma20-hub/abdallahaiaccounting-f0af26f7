        ...
        <BrowserRouter>
          <AuthProvider>
            ...
            <Routes>
              ...
              <Route path="/employee/roster" element={<ProtectedRoute><RoleGuard allowedRoles={["employee"]} fallback="/auth" allowEmployeePerm="can_manage_schedule"><EmployeeApp initialTab="manager-roster" /></RoleGuard></ProtectedRoute>} />

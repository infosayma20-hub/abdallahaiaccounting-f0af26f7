...
const HRChatPage = lazy(() => import("./pages/hr/HRChatPage"));
...
const POSVarianceReviewPage = lazy(() => import("./pages/POSVarianceReviewPage"));
...
const EmployeeEvaluationsPage = lazy(() => import("./pages/hr/EmployeeEvaluationsPage"));
...
const ParentAccountFixPage = lazy(() => import("./pages/ParentAccountFixPage"));
const ContactBalanceReconciliationPage = lazy(() => import("./pages/ContactBalanceReconciliationPage"));
                  ...
                  <WebLayout>
                    ...
                    <Routes>
                     ...
                     <Route path="/purchases/returns/new" element={<ReturnCreatePage returnType="purchase" />} />
                      ...
                      <Route path="/finance/parent-account-fix" element={<ParentAccountFixPage />} />
                     <Route path="/finance/contact-balance-reconciliation" element={<ContactBalanceReconciliationPage />} />
                     <Route path="/finance/receipts" element={<FinanceReceiptsPage />} />
                      ...
                      <Route path="/finance/settings/journal-books" element={<JournalBooksPage />} />
                      ...
                      <Route path="/hr/chat" element={<HRShell><RoleGuard allowedRoles={["admin", "hr_manager"]}><HRChatPage /></RoleGuard></HRShell>} />
                      ...
                      <Route path="/pos-variance-review" element={<ModuleGuard><POSVarianceReviewPage /></ModuleGuard>} />

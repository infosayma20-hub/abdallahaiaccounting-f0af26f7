...
const ROUTE_META: Record<string, { title: string; icon: string }> = {
  ...
  "/hr/policy-assignment": { title: "إسناد السياسات", icon: "clipboard" },
  "/hr/form-access": { title: "إسناد النماذج", icon: "clipboard" },
  "/hr/form-templates": { title: "قوالب النماذج", icon: "clipboard" },
  "/hr/meal-deductions": { title: "خصومات الوجبات", icon: "dollar" },
  "/hr/leaves-balances": { title: "أرصدة الإجازات", icon: "usercheck" },
  "/hr/settlements": { title: "المخالصات", icon: "dollar" },
  "/hr/reports": { title: "تقارير الموارد البشرية", icon: "chart" },
  "/hr/messages-inbox": { title: "صندوق الرسائل", icon: "file" },
  "/hr/chat": { title: "محادثات الموارد البشرية", icon: "file" },
  ...
  "/stock-documents": { title: "سندات البضاعة", icon: "package" },
  "/stock-documents/new": { title: "سند بضاعة جديد", icon: "package" },
  "/finance/quick-import": { title: "الإدخال السريع", icon: "calculator" },
